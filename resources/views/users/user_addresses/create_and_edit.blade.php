            ...
            <div class="panel panel-default">
                ...
                <!-- 输出后端报错结束 -->
                    ...
                    <user-addresses-create-and-edit inline-template>
                        @if($address->id)
                            <form class="form-horizontal" role="form" action="{{ route('users.user_addresses.update', ['user_address' => $address->id]) }}" method="post">
                                {{ method_field('PUT') }}
                                @else
                                    <form class="form-horizontal" role="form" action="{{ route('users.user_addresses.store') }}" method="post">
                                    @endif
                                    {{ csrf_field() }}
                        <!-- 注意这里多了 @change -->
